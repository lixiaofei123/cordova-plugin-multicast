...
public class SingleChatAudioDataEncoder extends AbstractDataEncoder {
	...
	public boolean canHandle(String data) {
		try {
			...
			return type.equals("chat") && subType.equals("audio");
		} catch (Exception e) {
			throw new RuntimeException(e.getMessage());
		}
	}
