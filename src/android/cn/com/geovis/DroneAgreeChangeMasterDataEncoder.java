...
public class DroneAgreeChangeMasterDataEncoder extends AbstractDataEncoder {

	
	public static final byte MESSAGE_TYPE = 37;
	...
	public boolean canHandle(String data) {
		 try {
		      ...
		      return type.equals("changeMaster") && superType.equals("agree"); 
		    } catch (Exception e) {
	...
	public static void main(String[] args) {
		...
		String msg = "{type:'changeMaster',superType:'agree',newMaster:123}";
