...
public class TaskPersonSyncDataEncoder extends AbstractDataEncoder {
  public static final byte MESSAGE_TYPE = 32;
  ...
  public boolean canHandle(String data) {
    try {
      ...
      return (
        type.equals("sync-free_taskCompletion") && op.equals("updatePersonTask")
      );
    } catch (Exception e) {
  ...
  public static void main(String[] args) {
    ...
    String msg =
      "{type:'sync-free_taskCompletion',op:'updatePersonTask',taskinfo:'今天天气明媚，小雨转晴，温度36度'}";
    System.out.println(
